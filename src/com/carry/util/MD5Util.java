...
public class MD5Util {  
    ...
    public static void main(String[] args) {
		...
		String yh = "admin";//账号
		String pd = "8888888";//明文密码
		String password = md5.getMD5ofStr(pd);
		//加盐用户名之后第二次MD5(必须小写)
		password = md5.getMD5ofStr("052112979XdzGa0x!ntongjitjbbcyzcsh20190228");
		System.out.println(password);
       /*SimpleDateFormat dateFormat=new SimpleDateFormat("yyyy-MM-dd");
       String key=Md5Pass.MD5Encode("2e4J6Jc/HHkfYC5csKjZIg==Carry2017"+dateFormat.format(new Date()));
       String str="wz0%40%E5%8F%82%E6%95%B0%E6%88%96%E7%BD%91%E7%BB%9C%E5%BC%82%E5%B8%B8";
        str= Md5Pass.decodeUTF8(str);
